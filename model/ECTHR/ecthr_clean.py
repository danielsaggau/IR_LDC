...
def main():
    ...
    if data_args.dataset_selection=="ecthr_a":
        ...
        model = AutoModelForSequenceClassification.from_pretrained("danielsaggau/",
        num_labels=10, problem_type='multi_label_classification')
        logger.info('load ecthr_a model')
        ...
        model = AutoModelForSequenceClassification.from_pretrained("danielsaggau/simcse_longformer_ecthr_b",
        num_labels=10, problem_type='multi_label_classification')
        logger.info('load ecthr_b model')
